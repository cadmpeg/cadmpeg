...
- **Rhino `.3dm` — [L6](docs/format-support.md#support-ladder) for archive 50/60/70/80:** complete built-in shape carriers, connected topology, native constructions, dimensions, and ordered history semantics; older bands have inspection and metadata support.
