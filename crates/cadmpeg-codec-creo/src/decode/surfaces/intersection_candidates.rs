...
const EPS_CENTER_ALIGNMENT: f64 = 1e-9;
const EPS_TANGENT_ROOT: f64 = 1e-9;
const EPS_NONZERO_SLOPE: f64 = 1e-12;
const EPS_POSITIVE_RADIUS: f64 = 1e-12;
const EPS_COINCIDENT_CENTER: f64 = 1e-12;
const EPS_MERIDIAN_ROOT: f64 = 1e-12;
