...
#[cfg(test)]
#[allow(unused_imports)]
pub(super) use pcurves::solve_pcurve_vertex_domains;
#[allow(unused_imports)]
pub(super) use pcurves::{
    ...
    pcurve_edge_endpoints, planar_curve_pcurve, reconcile_support_apex_cone_parameter_branches,
...
pub(super) use vertices::{
    ...
    solve_topological_vertices, solved_topological_vertices, TopologicalVertexSolveDiagnostics,
};
