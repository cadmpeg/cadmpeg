...
fn equation_function_two_emits_radius_dimension_constraint_with_incomplete_segment_table() {
    ...
    assert_eq!(
        ...
        SketchConstraintDefinition::Radius {
            ...
            parameter: ParameterId::mint("creo:featdefs:parameter#40:100").expect("identity grammar"),
        }
    );
...
fn equation_function_three_emits_parameterized_coordinate_distance() {
    ...
    assert_eq!(
        ...
        SketchConstraintDefinition::HorizontalDistance {
            ...
            parameter: ParameterId::mint("creo:featdefs:parameter#40:27").expect("identity grammar"),
        }
    );
