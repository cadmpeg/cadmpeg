...
use crate::vocab::{
    ...
    COMMON_DATUM_LIST, CONCENTRICITY_TOLERANCE, CYLINDRICITY_TOLERANCE, DATUM,
    DATUM_REFERENCE_COMPARTMENT, DATUM_REFERENCE_ELEMENT, DATUM_REFERENCE_MODIFIER_WITH_VALUE,
    DATUM_SYSTEM, DIMENSIONAL_CHARACTERISTIC_REPRESENTATION, DIMENSIONAL_LOCATION,
    DIMENSIONAL_SIZE, DRAUGHTING_MODEL, DRAUGHTING_MODEL_ITEM_ASSOCIATION,
    EXTERNALLY_DEFINED_TEXT_FONT, EXTERNAL_SOURCE, FLATNESS_TOLERANCE, LENGTH_MEASURE,
    LENGTH_MEASURE_WITH_UNIT, LIMITS_AND_FITS, LINE_PROFILE_TOLERANCE, MEASURE_REPRESENTATION_ITEM,
    MEASURE_WITH_UNIT, PARALLELISM_TOLERANCE, PERPENDICULARITY_TOLERANCE, PLANE_ANGLE_MEASURE,
    PLANE_ANGLE_MEASURE_WITH_UNIT, PLUS_MINUS_TOLERANCE, POSITION_TOLERANCE,
    PRESENTATION_STYLE_ASSIGNMENT, RATIO_MEASURE, ROUNDNESS_TOLERANCE, SHAPE_ASPECT,
    SHAPE_DIMENSION_REPRESENTATION, STRAIGHTNESS_TOLERANCE, SURFACE_PROFILE_TOLERANCE,
    SYMMETRY_TOLERANCE, TEXT_LITERAL, TOLERANCE_VALUE, TOTAL_RUNOUT_TOLERANCE,
};
