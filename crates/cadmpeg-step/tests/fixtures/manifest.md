...
| `ap242_geometry.p21` | millimetre unit context, analytic/polyline carriers, unknown-periodicity NURBS, parameter and Cartesian trims, trimmed composite, direct/set/source geometry styles, and null style |
