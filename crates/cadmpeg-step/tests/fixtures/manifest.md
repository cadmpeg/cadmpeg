...
| `ap242_geometry.p21` | millimetre unit context, analytic/polyline carriers, unknown-periodicity NURBS, parameter and Cartesian trims, standalone geometric-set representation, trimmed composite, direct/set/source geometry styles, and null style |
