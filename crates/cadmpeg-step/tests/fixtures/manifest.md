...
| `ap242_geometry.p21` | millimetre unit context, analytic carriers, unknown-periodicity NURBS, parameter and Cartesian trims, trimmed composite, direct/set geometry styles, and null style |
