...
use validation_tests::{
    ...
    validate_consolidated_edge_runs, validate_consolidated_embedded_cylinders,
    validate_consolidated_groups, validate_consolidated_line_profiles,
    validate_consolidated_owner_packets, validate_consolidated_parameter_points,
    ...
    validate_consolidated_spheres, validate_consolidated_tori, validate_native_links,
