...
use crate::test_support::test_formula::standard_catpart_with_typed_formula_inputs;
...
fn decode_evaluates_formula_precedence_and_parentheses() {
    ...
    assert_eq!(
        ...
        Some(cadmpeg_ir::features::ParameterValue::Length(
            cadmpeg_ir::scalar::Length::new(30.0).unwrap()
        ))
    );
}
...
fn decode_evaluates_the_dimensionless_pi_constant_in_an_angle_expression() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Angle(
            cadmpeg_ir::scalar::Angle::new(output_value).unwrap()
        ))
    );
}
...
fn decode_evaluates_dimensionless_trigonometric_arguments_as_radians() {
    ...
    assert_eq!(
        ...
        Some(cadmpeg_ir::features::ParameterValue::Real(
            cadmpeg_ir::scalar::FiniteReal::new(0.0).unwrap()
        ))
    );
}
...
fn decode_evaluates_nested_logarithm_and_extrema_calls() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Real(
            cadmpeg_ir::scalar::FiniteReal::new(output_value).unwrap()
        ))
    );
}
...
fn decode_normalizes_every_admitted_formula_angle_unit_to_radians() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Angle(
            cadmpeg_ir::scalar::Angle::new(expected).unwrap()
        ))
    );
}
...
fn decode_evaluates_scalar_rounding_functions() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Real(
            cadmpeg_ir::scalar::FiniteReal::new(8.0).unwrap()
        ))
    );
}
...
fn decode_evaluates_dimensioned_rounding_in_the_selected_unit() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Length(
            cadmpeg_ir::scalar::Length::new(1_230.0).unwrap()
        ))
    );
}
...
fn decode_evaluates_variadic_extrema_and_integer_part_remainder() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Real(
            cadmpeg_ir::scalar::FiniteReal::new(9.0).unwrap()
        ))
    );
}
...
fn decode_evaluates_right_associative_exponentiation_above_unary_signs() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Real(
            cadmpeg_ir::scalar::FiniteReal::new(-512.0).unwrap()
        ))
    );
}
...
fn decode_evaluates_an_integral_power_of_a_dimensioned_value() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Length(
            cadmpeg_ir::scalar::Length::new(3.0).unwrap()
        ))
    );
}
...
fn decode_converts_metric_length_literals_to_millimetres() {
    ...
    assert_eq!(
        output.value,
        Some(cadmpeg_ir::features::ParameterValue::Length(
            cadmpeg_ir::scalar::Length::new(1_023.0).unwrap()
        ))
    );
}
