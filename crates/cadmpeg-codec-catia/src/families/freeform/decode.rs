...
//!
//! Transfers the b5 object-stream topology first and falls back to the a5a8/b2
//! surface carriers when the b5 reference graph does not close. Also owns the
//! surface and resolved-curve pools the standard route drives.

use cadmpeg_ir::annotations::AnnotationBuilder;
use cadmpeg_ir::document::CadIr;
use cadmpeg_ir::geometry::{
    Curve, CurveGeometry, IntcurveSupportContext, IntcurveSupportSide, NurbsCurve, ProceduralCurve,
    ProceduralCurveDefinition, ProceduralSurface, ProceduralSurfaceDefinition, RollingBallJetSite,
...
use crate::assemble::{
    ...
    preserve_raw_payload, source_meta,
};
use crate::container::{self, ContainerScan};
use crate::families::freeform::records::{
    consolidated_jet_pcurve, freeform_surface_carriers, rolling_ball_derivative,
    ConsolidatedCarrierChart, ConsolidatedCarrierKey,
};
