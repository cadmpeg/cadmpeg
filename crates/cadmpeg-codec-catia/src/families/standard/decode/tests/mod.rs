...
pub(super) use crate::families::standard::decode::{
    ...
    standard_line_pair_solution_is_simple_cached, standard_native_support_endpoint_pair,
    standard_object_evidence_from_streams, standard_oriented_analytic_curve_parameter_range,
    standard_oriented_native_support_pcurves, standard_pcurve_geometry,
    standard_plane_normals_from_face_frames, standard_serialized_endpoint_pairs,
    standard_shared_boundary_group_domains, standard_shared_nurbs_boundary_pair_options,
    standard_spline_line, standard_successor_endpoint_pairs, standard_successor_endpoint_points,
