...
fn native_namespace_retains_zero_entity_surface_support_runs() {
    ...
    invalid_face.zero_entity_support_runs[0]
        ...
        .expect("face")
        .loop_terminals[0] = 8;
    let mut invalid_face_namespace = cadmpeg_ir::NativeNamespace::new();
    invalid_face
    ...
    zero_face_terminal.zero_entity_support_runs[0]
        ...
        .expect("face")
        .loop_terminals[0] = 0;
    let mut zero_face_terminal_namespace = cadmpeg_ir::NativeNamespace::new();
    zero_face_terminal
    ...
    invalid_loop_roster.zero_entity_support_runs[0]
        ...
        .loops[0]
        .loop_class = 0x50;
    let mut invalid_loop_roster_namespace = cadmpeg_ir::NativeNamespace::new();
    invalid_loop_roster
    ...
    invalid_face_allocation.zero_entity_support_runs[0]
        ...
        .expect("face")
        .allocations[0] = 0;
    let mut invalid_face_allocation_namespace = cadmpeg_ir::NativeNamespace::new();
    ...
    let mut invalid_face_control_namespace = cadmpeg_ir::NativeNamespace::new();
    ...
    invalid_loop_gap.zero_entity_support_runs[0]
        ...
        .loops[0]
        .gap = 0;
    let mut invalid_loop_gap_namespace = cadmpeg_ir::NativeNamespace::new();
    invalid_loop_gap
    ...
    let mut invalid_support_slot_namespace = cadmpeg_ir::NativeNamespace::new();
    ...
    invalid_loop.zero_entity_support_runs[0]
        ...
        .forward_senses
        .clear();
    let mut invalid_loop_namespace = cadmpeg_ir::NativeNamespace::new();
    invalid_loop
    ...
    let mut invalid_typed_record_namespace = cadmpeg_ir::NativeNamespace::new();
    ...
    let mut invalid_binding_namespace = cadmpeg_ir::NativeNamespace::new();
    invalid_binding
    ...
    let mut invalid_model_curve_namespace = cadmpeg_ir::NativeNamespace::new();
    invalid_model_curve
    ...
    invalid_model_parameters.zero_entity_support_runs[0].supports[0].model_parameters =
        Some([1.0, 1.0]);
    let mut invalid_model_parameters_namespace = cadmpeg_ir::NativeNamespace::new();
    ...
    let mut missing_model_midpoint_namespace = cadmpeg_ir::NativeNamespace::new();
    ...
    let mut invalid_model_construction_namespace = cadmpeg_ir::NativeNamespace::new();
    ...
    let mut invalid_oriented_endpoint_namespace = cadmpeg_ir::NativeNamespace::new();
    ...
    let mut invalid_endpoint_pair_namespace = cadmpeg_ir::NativeNamespace::new();
    invalid_endpoint_pair
    ...
    let mut invalid_endpoint_locus_namespace = cadmpeg_ir::NativeNamespace::new();
    invalid_endpoint_locus
    ...
    invalid_model_endpoint.zero_entity_support_runs[0].supports[0]
        ...
        .x = f64::NAN;
    let mut invalid_model_endpoint_namespace = cadmpeg_ir::NativeNamespace::new();
