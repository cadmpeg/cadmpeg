...
fn finish_decode(
    ...
    let structurally_owned_definition_chain_count = native
        .entity_records
        .iter()
        .filter(|record| {
        ...
        .count();
    let unowned_definition_chain_count = definition_chain_evaluation_count
        .checked_sub(structurally_owned_definition_chain_count)
    ...
    report.coverage.extend([
        ...
        (
            "decoded_structurally_owned_definition_chain_count".to_string(),
            structurally_owned_definition_chain_count,
        ),
        (
            "unresolved_definition_chain_owner_count".to_string(),
            unowned_definition_chain_count,
        ),
        (
