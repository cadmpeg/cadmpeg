...
fn finish_decode(
    ...
    let parameter_value_count = native
        ...
        .count();
    let definition_evaluation_count = native
        .entity_records
        .iter()
        .filter(|record| record.definition_evaluation.is_some())
        .count();
    ...
    report.coverage.extend([
        ...
        (
            "decoded_definition_evaluation_count".to_string(),
            definition_evaluation_count,
        ),
        (
