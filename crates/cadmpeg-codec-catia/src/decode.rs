...
fn finish_decode(
    ...
    let (
        ...
        .fold(
            (0_usize, 0_usize, 0_usize, 0_usize),
            |(total, no_slot, finite, unset), range| {
                let Some(slots) = &range.interval.slots else {
                    return (total + 1, no_slot + 1, finite, unset);
                };
