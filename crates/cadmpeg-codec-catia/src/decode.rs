...
fn finish_decode(
    ...
    let transferred_circular_pattern_feature_count =
        design_feature_transfer.circular_pattern_feature_count;
    let transferred_linear_pattern_feature_count =
        design_feature_transfer.linear_pattern_feature_count;
    ...
    let formula_parameter_dependency_count = native
        ...
        .sum();
    let escaped_word_entity_suffix_count = native
        .entity_records
        .iter()
        .filter(|record| record.suffix_escaped_word.is_some())
        .count();
    ...
    let structurally_owned_records = native
        ...
        .collect::<HashSet<_>>();
    let structurally_owned_constraint_range_count = native
        .entity_records
        .iter()
        .filter(|record| {
            record.constraint_range.is_some()
                && structurally_owned_records.contains(&record.object_record)
        })
        .count();
    let unowned_constraint_range_count = constraint_range_count
    ...
    let transferred_principal_plane_records = design_feature_transfer
        ...
        .cloned()
        .collect::<HashSet<_>>();
    let transferred_pattern_declaration_records = design_feature_transfer
        .pattern_records
        .intersection(&structurally_owned_records)
        .cloned()
        .collect::<HashSet<_>>();
    ...
    report.coverage.extend([
        ...
        (
            "decoded_structurally_owned_constraint_range_count".to_string(),
            structurally_owned_constraint_range_count,
        ),
        (
            "unresolved_constraint_range_owner_count".to_string(),
            unowned_constraint_range_count,
        ),
        (
        ...
        (
            "transferred_pattern_declaration_record_count".to_string(),
            transferred_pattern_declaration_records.len(),
        ),
        (
            "transferred_circular_pattern_feature_count".to_string(),
            transferred_circular_pattern_feature_count,
        ),
        (
            "transferred_linear_pattern_feature_count".to_string(),
            transferred_linear_pattern_feature_count,
        ),
        (
