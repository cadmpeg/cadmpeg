...
use super::{
    ...
    legacy_state_five_curve_endpoint_indices, legacy_state_one_profile_line_uses_point_roster,
    ...
    packed_legacy_curve_endpoint_indices, relation_reference_curve_record,
