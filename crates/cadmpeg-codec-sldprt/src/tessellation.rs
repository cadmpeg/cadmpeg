...
impl Mesh {
    ...
    ) -> Result<cadmpeg_ir::tessellation::Tessellation, cadmpeg_ir::tessellation::TessellationError>
    {
        cadmpeg_ir::tessellation::Tessellation::from_decoded(
            ...
            self.triangles,
            self.strip_lengths,
            cadmpeg_ir::tessellation::NormalSamples::new(self.normals).map_or(cadmpeg_ir::tessellation::TessellationNormals::None, cadmpeg_ir::tessellation::TessellationNormals::per_vertex),
            self.channels,
        )
    }
}
