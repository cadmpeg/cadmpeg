...
const EPS_LITERALS_VALID_PLANE_FRAME_E9: f64 = 1e-9;
const EPS_LITERALS_VALID_COORDINATE_FRAME_E9: f64 = 1e-9;
const EPS_LITERALS_PARSE_LENGTH_MM_E6: f64 = 1e-6;
const EPS_LITERALS_PARSE_LENGTH_MM_E7: f64 = 1e-7;
const EPS_LITERALS_FORMAT_F64_LITERAL_E6: f64 = 1e-6;
