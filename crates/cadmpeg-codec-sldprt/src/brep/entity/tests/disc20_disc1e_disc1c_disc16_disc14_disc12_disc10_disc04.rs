use super::super::disc20_disc1e_disc1c_disc16_disc14_disc12_disc10_disc04_face_root_body;
...
#[test]
fn keyed_lattice_owns_direct_faces() {
    let bodies = disc20_disc1e_disc1c_disc16_disc14_disc12_disc10_disc04_face_root_body(
        &index_records(&lattice()),
    );
    let [body] = bodies.as_slice() else {
        panic!("one disc20-disc1e-disc1c-disc16-disc14-disc12-disc10-disc04 body");
    };
...
fn keyed_lattice_rejects_broken_use_back_reference() {
    ...
    assert!(
        disc20_disc1e_disc1c_disc16_disc14_disc12_disc10_disc04_face_root_body(&index_records(
            &records,
        ))
        .is_empty()
    );
