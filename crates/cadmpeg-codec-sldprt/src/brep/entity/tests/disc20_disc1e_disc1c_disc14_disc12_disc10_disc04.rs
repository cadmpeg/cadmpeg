use super::super::disc20_disc1e_disc1c_disc14_disc12_disc10_disc04_face_root_body;
...
fn lattice() -> Vec<super::super::EntityRecord> {
    vec![
        ...
        record(21, 0x0e, [101, 999, 1, 1, 1, 1]),
...
#[test]
fn keyed_lattice_owns_direct_and_key_selected_faces() {
    let records = lattice();
    let bodies =
        disc20_disc1e_disc1c_disc14_disc12_disc10_disc04_face_root_body(&index_records(&records));
    let [body] = bodies.as_slice() else {
        panic!("one disc20-disc1e-disc1c-disc14-disc12-disc10-disc04 body");
    };
