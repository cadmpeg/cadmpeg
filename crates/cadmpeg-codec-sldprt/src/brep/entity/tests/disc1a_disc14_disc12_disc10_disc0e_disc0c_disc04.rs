use super::super::disc1a_disc14_disc12_disc10_disc0e_disc0c_disc04_face_root_body;
...
fn lattice_owns_direct_faces_and_ignores_unselected_records() {
    let bodies =
        disc1a_disc14_disc12_disc10_disc0e_disc0c_disc04_face_root_body(&index_records(&lattice()));
    let [body] = bodies.as_slice() else {
        panic!("one disc1a-disc14-disc12-disc10-disc0e-disc0c-disc04 body");
    };
...
fn lattice_rejects_a_broken_companion_back_reference() {
    ...
    assert!(
        disc1a_disc14_disc12_disc10_disc0e_disc0c_disc04_face_root_body(&index_records(&records))
            .is_empty()
    );
}
