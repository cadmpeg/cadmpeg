use super::super::disc20_disc1e_disc1c_disc18_disc16_disc10_disc04_face_root_body;
...
fn keyed_lattice_owns_directly_linked_faces() {
    let records = lattice();
    let bodies =
        disc20_disc1e_disc1c_disc18_disc16_disc10_disc04_face_root_body(&index_records(&records));
    let [body] = bodies.as_slice() else {
        panic!("one disc20-disc1e-disc1c-disc18-disc16-disc10 body");
    };
...
#[test]
fn keyed_lattice_uses_the_face_key_when_the_companion_link_is_not_reciprocal() {
    let mut records = lattice();
    records
        .iter_mut()
