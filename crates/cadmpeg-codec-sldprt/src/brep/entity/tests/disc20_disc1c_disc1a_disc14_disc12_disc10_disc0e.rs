use super::super::disc20_disc1c_disc1a_disc14_disc12_disc10_disc0e_face_root_body;
...
fn lattice() -> Vec<super::super::EntityRecord> {
    vec![
        ...
        record(20, 0x04, [100, 40, 1, 1, 1, 1]),
        record(21, 0x04, [101, 1, 1, 1, 1, 1]),
        record(40, 0x1e, [100, 50, 20, 1, 1, 1]),
        record(41, 0x1e, [101, 70, 1, 1, 1, 1]),
        record(70, 0x24, [101, 1, 1, 1, 1, 1]),
...
fn keyed_chain_accepts_reciprocal_and_keyed_links_with_extra_use_nodes() {
    let records = lattice();
    let bodies =
        disc20_disc1c_disc1a_disc14_disc12_disc10_disc0e_face_root_body(&index_records(&records));
    let [body] = bodies.as_slice() else {
        panic!("one disc20-disc1c-disc1a-disc14-disc12-disc10-disc0e body");
    };
...
fn keyed_chain_rejects_an_unselected_companion() {
    ...
    records.push(record(42, 0x1e, [102, 70, 1, 1, 1, 1]));
