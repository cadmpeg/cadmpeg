use super::super::disc20_disc1e_disc1c_disc18_disc16_disc12_disc04_face_root_body;
...
fn keyed_lattice_owns_bridged_faces() {
    let records = lattice();
    let bodies =
        disc20_disc1e_disc1c_disc18_disc16_disc12_disc04_face_root_body(&index_records(&records));
    let [body] = bodies.as_slice() else {
        panic!("one disc20-disc1e-disc1c-disc18-disc16-disc12-disc04 body");
    };
