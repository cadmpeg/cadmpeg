...
fn base_feature_scope_decodes_parallel_result_body_runs() {
    ...
    invalid_scope
        .try_edit(|draft| {
            draft.reference_members = crate::records::ReferenceRun::unlocated(vec![302]);
            draft.locate_fixture_references();
            draft.kind_offset =
...
fn base_feature_scope_decodes_class_409_262_result_body_variants() {
    ...
    zero_scope
        .try_edit(|draft| {
            ...
            draft.reference_members = crate::records::ReferenceRun::unlocated(vec![701]);
        ...
        scope
            .try_edit(|draft| {
                draft.reference_members =
                    crate::records::ReferenceRun::unlocated(vec![scope_reference]);
