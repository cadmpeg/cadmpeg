...
fn owner_scoped_radial_dimensions_preserve_repeated_measurements() {
    ...
    let radius_parameter = cadmpeg_ir::features::ParameterId::mint("parameter#radius").expect("identity grammar");
    assert!(matches!(
    ...
    let diameter_parameter = cadmpeg_ir::features::ParameterId::mint("parameter#diameter").expect("identity grammar");
    assert!(matches!(
        radial_dimension_definition(
            &entity,
...
fn owner_scoped_line_lengths_preserve_repeated_entities() {
    ...
    let parameter_id = cadmpeg_ir::features::ParameterId::mint("parameter#line-length").expect("identity grammar");
...
fn owner_scoped_angular_dimension_requires_one_matching_line_pair() {
    ...
    let parameter_id = cadmpeg_ir::features::ParameterId::mint("parameter#angle").expect("identity grammar");
...
fn owner_scoped_point_dimensions_quotient_coincident_identities() {
    ...
    .expect("linear parameter");
    let parameter_id = cadmpeg_ir::features::ParameterId::mint("parameter#point-classes").expect("identity grammar");
...
fn radial_locus_groups_use_direct_curves_then_unique_center_witnesses() {
    ...
    let parameter = cadmpeg_ir::features::ParameterId::mint("parameter#radial-loci").expect("identity grammar");
