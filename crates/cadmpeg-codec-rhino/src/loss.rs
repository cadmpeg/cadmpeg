...
/// The phrase every unverified-dialect diagnostic carries.
///
...
/// [`RhinoLossCode::SourceDialectUnverified`] instead of the generic
/// container/decode diagnostic, the same way integrity and redundant-field
/// diagnostics are promoted.
pub(crate) const DIALECT_UNVERIFIED_MARKER: &str = "the archive has no writer-version stamp";
...
pub enum RhinoLossCode {
    ...
    /// openNURBS writer-version stamp to verify the dialect against.
