...
/// is real — archives 1, 2, 3, 4, 5 and 90 decode without a writer, unknown
/// words decode as admitted-unverified, and 3DM has no retained-image path
/// that could write any of them back.
