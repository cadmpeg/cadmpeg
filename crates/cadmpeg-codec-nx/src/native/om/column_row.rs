...
#[serde(try_from = "wire::DataBlockIndexRowWire", into = "wire::DataBlockIndexRowWire")]
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(try_from = "wire::DataBlockLinkedIndexRowWire", into = "wire::DataBlockLinkedIndexRowWire")]
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(try_from = "wire::DataBlockTargetIndexRowWire", into = "wire::DataBlockTargetIndexRowWire")]
            ...
            crate::om::column_row::scan::index_rows(storage)
                ...
                .filter_map(|row| {
                    let opening = column_storage_block_at(
                        section_ordinal, records, storage_offset + row.offset(),
                    )?;
    ...
    container
        ...
        .flat_map(|(section_ordinal, (entry, section))| {
            ...
            crate::om::column_row::scan::linked_rows(storage)
                ...
                .enumerate()
                .map(
                    |(ordinal, (frame, opening))| DataBlockLinkedIndexRow {
                        id: format!(
    ...
    container
        ...
        .flat_map(|(section_ordinal, (entry, section))| {
            ...
            crate::om::column_row::scan::target_rows(storage)
                ...
                .enumerate()
                .map(
                    |(ordinal, (frame, opening))| DataBlockTargetIndexRow {
                        id: format!(
