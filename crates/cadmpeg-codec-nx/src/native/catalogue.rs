...
//!
//! One [`CatalogueRow`] per model field (188 total). Each row names the `nx`
...
pub(crate) struct CatalogueRow {
    ...
    /// Whether an empty family contributes to [`NativeModel::is_empty`]. 142 of
    /// the 188 families count; the 46 that do not are transcribed verbatim from
