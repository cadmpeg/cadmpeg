...
//!
//! One [`CatalogueRow`] per model field (189 total). Each row names the `nx`
...
pub(crate) struct CatalogueRow {
    ...
    /// Whether an empty family contributes to [`NativeModel::is_empty`]. 143 of
    /// the 189 families count; the 46 that do not are transcribed verbatim from
