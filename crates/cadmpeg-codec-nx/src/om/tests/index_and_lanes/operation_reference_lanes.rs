...
fn om_projected_curve_references_require_one_complete_field() {
    ...
    malformed[17] = 0x00;
    assert!(
        super::super::projected_curve_payload_references(crate::om::operation_record::OperationPayload::new(&malformed, record.payload_offset(), record.name()).unwrap())
        .is_none()
    );

    let ambiguous = [payload.as_slice(), payload.as_slice()].concat();
    assert!(
        super::super::projected_curve_payload_references(crate::om::operation_record::OperationPayload::new(&ambiguous, record.payload_offset(), record.name()).unwrap())
        .is_none()
    );
}
...
fn om_combined_projected_curve_references_require_the_complete_graph() {
    ...
    assert!(
        super::super::projected_curve_payload_references(crate::om::operation_record::OperationPayload::new(&inconsistent, record.payload_offset(), record.name()).unwrap())
        .is_none()
    );
...
fn om_pattern_reference_graph_preserves_nullable_terminal_slot() {
    ...
    let field = super::super::pattern_payload_references(crate::om::operation_record::OperationPayload::new(&populated, record.payload_offset(), "Pattern Feature").unwrap())
    ...
    malformed[18] = 0x60;
    assert!(
        super::super::pattern_payload_references(crate::om::operation_record::OperationPayload::new(&malformed, record.payload_offset(), record.name()).unwrap())
        .is_none()
    );
    ...
    let field = super::super::pattern_payload_references(crate::om::operation_record::OperationPayload::new(compact, record.payload_offset(), record.name()).unwrap())
...
fn om_pattern_transform_lanes_require_counted_family_rows() {
    ...
    let record = crate::om::operation_record::OperationPayload::new(feature_payload, 200, label).unwrap();
    ...
    let geometry_record = crate::om::operation_record::OperationPayload::new(geometry_payload, record.payload_offset(), "Pattern Geometry").unwrap();
    let lane =
    ...
    let schema_relative_payload = b"\x01\x04\
        ...
        \x3c\x00\x00\x01";
    let relative_lane =
        super::super::pattern_payload_transform_lane(crate::om::operation_record::OperationPayload::new(schema_relative_payload, record.payload_offset(), record.name()).unwrap())
    ...
    let wide_payload = b"\x01\x03\
        ...
        \x34\x00\x00\x02";
    let wide_lane = super::super::pattern_payload_transform_lane(crate::om::operation_record::OperationPayload::new(wide_payload, record.payload_offset(), record.name()).unwrap())
    ...
    assert!(
        super::super::pattern_payload_transform_lane(crate::om::operation_record::OperationPayload::new(&zero_terminal_value, record.payload_offset(), record.name()).unwrap())
        .is_none()
    );
    ...
    assert!(
        super::super::pattern_payload_transform_lane(crate::om::operation_record::OperationPayload::new(&changed_schema, record.payload_offset(), record.name()).unwrap())
        .is_none()
    );
    ...
    wrong_ordinal[29] = 2;
    assert!(
        super::super::pattern_payload_transform_lane(crate::om::operation_record::OperationPayload::new(&wrong_ordinal, record.payload_offset(), record.name()).unwrap())
        .is_none()
    );
    assert!(
        super::super::pattern_payload_transform_lane(crate::om::operation_record::OperationPayload::new(&feature_payload[..feature_payload.len() - 1], record.payload_offset(), record.name()).unwrap())
        .is_none()
    );
}
