...
mod tests {
    ...
    use crate::om::{
        audit_trail_rows, operation_state_group_table,
        operation_state_group_table_before_counter_map, operation_state_journal,
        operation_state_journal_groups_before_boundary, operation_state_journal_start,
    ...
    fn operation_state_group_table_decodes_list_pair_and_empty_groups() {
        let bytes = [
            0x01, 0x00, 0x01, 0x03, 0x4a, 0x83, 0xba, 0x01, 0xff, 0x4a, 0x83, 0xb7, 0x02, 0xff,
            0x01, 0x01, 0x01, 0x02, 0x4f, 0xf1, 0x04, 0x2d, 0x83, 0xe1, 0xff, 0xff, 0x01, 0x01,
            0x00,
        ];
    ...
    fn operation_state_group_table_anchors_to_counter_map_boundary() {
        ...
        bytes.extend([
            0x05, 0x01, 0x83, 0x20, 0x01, 0x02, 0x4e, 0x05, 0x02, 0x90, 0x12, 0x34, 0x03, 0x04,
            0x4e,
        ]);
    ...
    fn operation_state_journal_decodes_timestamp_value_schema_and_ordinal() {
        let bytes = [
            0x04, 0x01, 0x02, 0x00, 0x00, 0xe0, 0x65, 0x53, 0x4d, 0x20, 0xc0, 0x01, 0x02, 0x03,
            0x83, 0x10, 0x2a, 0x13,
        ];
    ...
    fn audit_trail_rows_retain_optional_selector_variable_value_width_and_raw_bytes() {
        let bytes = [
            0x41, 0x00, 0x03, 0x05, 0x01, 0x04, 0x00, 0x04, 0x02, 0x13, 0xe0, 0x65, 0x53, 0x4d,
            0x20, 0xe0, 0x01, 0x02, 0x03, 0x04, 0x04, 0x03, 0x13, 0x04, 0x05, 0x07, 0x00, 0xe0,
            0x65, 0x53, 0x4d, 0x21, 0xc0, 0x01, 0x02, 0x03, 0x04, 0x04, 0x04, 0x13, 0x04, 0x00,
        ];
