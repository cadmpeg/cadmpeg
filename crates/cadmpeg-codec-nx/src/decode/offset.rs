...
use sample_count::CoarseSampleCount;

const EPS_OFFSET_OFFSET_SURFACE_PARAMETERS_WITH_TOLERANCE_WITH_INDEX_E12: f64 = 1.0e-12;
const EPS_OFFSET_REFINE_OFFSET_SURFACE_PARAMETERS_WITH_INDEX_E12: f64 = 1.0e-12;
const EPS_OFFSET_PARAMETER_DERIVATIVE_STEP_E6: f64 = 1.0e-6;
const EPS_OFFSET_CORRECT_INTERSECTION_PARAMETERS_E6: f64 = 1.0e-6;
const EPS_OFFSET_CORRECT_INTERSECTION_PARAMETERS_E11: f64 = 1.0e-11;
...
pub(super) fn least_squares_step(
    ...
    let u = cadmpeg_ir::math::multiply_divide(
        (dv_squared * du_residual - mixed * dv_residual) / determinant,
        residual_scale,
        du_scale,
    )?;
    let v = cadmpeg_ir::math::multiply_divide(
