...
//! to [`cadmpeg_core::compare::values_agree`], which holds structure exact, tolerates
...
//!
//! The tolerance hides drift below [`cadmpeg_core::compare::FLOAT_TOLERANCE`] relative
...
use cadmpeg_core::compare::{is_local_digest_attribute, values_agree};
...
///
/// Byte-equal fast path; otherwise JSON via [`cadmpeg_core::compare::values_agree`],
...
mod tests {
    ...
    use cadmpeg_core::compare::FLOAT_TOLERANCE;
