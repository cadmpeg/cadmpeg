...
fn compound_curve_requires_components_and_finite_parameters() {
    ...
    for invalid in [f64::NAN, f64::INFINITY, f64::NEG_INFINITY] {
        assert!(CompoundCurveConstruction::try_new(vec![invalid], vec![component()], None).is_err());
    ...
    let unordered = CompoundCurveConstruction::try_new(vec![2.0, -1.0], vec![component()], None).unwrap();
