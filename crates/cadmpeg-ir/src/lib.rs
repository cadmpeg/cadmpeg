...
pub use report::{
    ...
    ExportReport, FidelityResolution, Finding, LossCategory, LossKind, LossNote, LossTaxonomy,
    Severity, StrictConsequence, ValidationReport, WritePath, SHARED_LOSS_NAMESPACE,
};
pub use sketches::{
