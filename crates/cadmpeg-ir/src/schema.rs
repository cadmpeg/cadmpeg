...
impl_entity_schema!(crate::topology::Coedge, Coedge, id.0; id, owner_loop, edge, next, previous, radial_next, sense, pcurves, use_curve, use_curve_parameter_range);
...
impl_entity_schema!(crate::sketches::Sketch, Sketch, id.0; id, name, configuration, placement, profiles, native_ref);
...
impl_entity_schema!(crate::sketches::SpatialSketch, SpatialSketch, id.0; id, name, configuration, profiles, native_ref);
impl_entity_schema!(
...
impl_entity_schema!(crate::tessellation::Tessellation, Tessellation, id; id, body, faces, chordal_deflection, source_object, vertices, triangles, feature_edges, strip_lengths, normals, corner_normals, channels);
