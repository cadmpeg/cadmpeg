...
Format names and CAD application names (SolidWorks, Autodesk Fusion, Autodesk Inventor, Creo, NX, Rhino, CATIA, FreeCAD, ShapeManager, ACIS, Parasolid, and others) are trademarks of their respective owners. cadmpeg uses them only nominatively, to say which files a decoder targets. cadmpeg is not affiliated with, endorsed by, or sponsored by any of these vendors.
