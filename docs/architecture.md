...
| `cadmpeg-ir`           | Layered version 4 IR model, canonical JSON, free-carrier source associations, sparse provenance and exactness, native namespaces, structural diff, validation, codec traits, and report types.                 |
