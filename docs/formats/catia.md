...
A transferred named parameter belongs to a transferred feature when its entity's positionally paired object record belongs to that feature's design object. Owned parameters occur in that feature's source-content sequence in entity byte order. An absent object record, an unowned object record, or a design object without a transferred feature leaves the parameter at document scope.
