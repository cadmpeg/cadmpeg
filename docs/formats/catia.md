...
A transferred named parameter belongs to a transferred feature when its entity's positionally paired object record belongs to that feature's design object. An absent object record, an unowned object record, or a design object without a transferred feature leaves the parameter at document scope.
