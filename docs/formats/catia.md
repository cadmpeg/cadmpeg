...
For `b5 03 2b`, the 201-byte payload is `<lead> <center:3f64> <direction_x:3f64> <direction_y:3f64> <axis:3f64> <major_radius:f64> <minor_radius:f64> <major_range:2f64> <major_domain:2f64> <minor_range:2f64> <minor_domain:2f64> <major_scale:f64> <minor_scale:f64> <8B>`. Both geometric radii and both parameter scales are positive. The active angular ranges and full-turn domains obey the `b2 03 2b` range/domain invariants. Native parameters use the independent gauges `major_angle=U/major_scale` and `minor_angle=V/minor_scale`. The point is `center+(major_radius+minor_radius·cos(minor_angle))·(cos(major_angle)·direction_x+sin(major_angle)·direction_y)+minor_radius·sin(minor_angle)·axis`. The neutral chart is `(major_angle,minor_angle)`.
