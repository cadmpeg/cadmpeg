...
- `b5 03 18` (analytic line pcurve): payload `81 surface_ref 01 <u0:f64le> <v0:f64le> <du:f64le> <dv:f64le> <t0:f64le> <t1:f64le>`. It defines `P(t) = (u0,v0) + t(du,dv)` on `t0 <= t <= t1` in the referenced surface chart. The equivalent clamped B-spline has degree 1, knots `[t0,t1]` with multiplicities `[2,2]`, and endpoint poles `P(t0),P(t1)`.
