...
A uniquely linked reference-handle chain resolves to its terminal profile locus. A unique linked locus supersedes a non-unique coordinate-derived locus for the same handle. Cyclic chains and chains with multiple terminal loci remain unresolved. A relation handle whose linked chains identify one common profile entity identifies that entity.
