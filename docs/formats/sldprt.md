...
The compact `moCompRefPlane_c` record binds the profile to a principal plane. Its nonzero little-endian u32 feature source identifier precedes an opaque u32 identity, `00 00 03 00`, 27 zero bytes, the little-endian f64 value `1`, and `00 00 00 04 00 00 00 f9 ff ff ff 00 00 00 00 65`. The record belongs to the profile when it lies between the preceding feature object's name and the end of the profile feature object. Source identifier `2` selects the front principal plane. Front-plane sketch coordinates use origin `(0,0,0)`, normal `(0,-1,0)`, and u-axis `(0,0,-1)` in model space.
