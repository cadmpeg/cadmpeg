...
An axis-aligned sketch placement supersedes profile-derived coordinate transforms. The placement transform treats the marker coordinate pair as the two ascending world-coordinate components other than the sketch-normal axis and maps them through the stored origin and sketch axes. It supplies the frame independently of profile anchors.
