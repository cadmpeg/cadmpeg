...
- Sheet-metal (`BaseFlange`, `EdgeFlange`, `Hem`), `RemoveBody`, surface `Stitch`, and `CopyPasteBodies` parameter-scope kinds have no neutral scope grammar; their owned parameters retain native operation semantics.
