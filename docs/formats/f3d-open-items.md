...
- The indexed parameter companion has a fixed prefix, an owner backlink, an exact owned interval, and an ordered set of contained construction recipes. The semantic role of its opaque u64 and the operation grammar relating recipes in non-locus companion variants are unresolved.
