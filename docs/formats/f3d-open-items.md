...
- Sheet-metal (`BaseFlange`, `EdgeFlange`, `Hem`), surface `Stitch`, and `CopyPasteBodies` parameter-scope kinds have no neutral operation grammar; their owned parameters retain native operation semantics.
