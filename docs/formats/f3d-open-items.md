...
- The `law_spl_sur` family lacks complete carrier semantics. The primitive-reduction paths `plane/plane -> cylinder` and `plane/cylinder perpendicular -> torus` also lack defined carrier semantics.
