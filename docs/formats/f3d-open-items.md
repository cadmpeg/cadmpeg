...
- Outside a role-`0x0000000500000000` spatial-Sketch Loft section, the individual entity roles of the two u64 values in a nested Loft entity-selection member's `N+3` record remain unresolved.
