...
- The sketch placement frame joining `EntityGenesis`-form sketch entity headers to a local-to-model transform is unresolved; sketches in that header form decode their geometry, relations, and owners but project no neutral sketch.
