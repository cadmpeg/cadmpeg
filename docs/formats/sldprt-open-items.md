...
- Neutral invariants and operand roles for constraint codes `29..85` remain incomplete. Code `28` is the coradial relation. All native identities and the numeric taxonomy through `85` are defined. Codes above `85` are unresolved native extensions.
