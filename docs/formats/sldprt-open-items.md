...
- `ResolvedFeatures` relation families other than point-point, line-line, point-line, horizontal and vertical distances, angular relations, circle diameter, and unambiguous unary horizontal, vertical, and fixed marker relations; operand-to-profile-locus ownership; and relation expressions are unresolved.
