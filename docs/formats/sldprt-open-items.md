...
- Neutral invariants and operand roles for constraint codes `28..85` remain incomplete. Their native identities and numeric taxonomy are defined. Codes above `85` are unresolved native extensions.
