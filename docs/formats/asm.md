...
A revision-gated `cyl_spl_sur` ends at the shared surface tail. The subtype close follows the tail immediately; another token before the close does not belong to this layout.
