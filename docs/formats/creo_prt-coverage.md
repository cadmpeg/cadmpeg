...
- Fixed-ordinate section axes with unresolved along-line coordinates remain
  unbounded through solver intersections and construction-line transfer; no
  finite endpoint extent is inferred.
