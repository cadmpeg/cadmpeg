...
Within a dimensional companion, every contained construction-recipe family name belongs to the immediately preceding indexed record header. The containing record ends at the next indexed record header or at the end of the companion-owned payload. The containing header's byte offset, dynamic class tag, record index, frame length, companion identity, and recipe ordinal are retained with the recipe identity.
