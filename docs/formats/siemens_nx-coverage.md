...
| L2 | Incomplete | Establish serialized identity between graph-only NURBS-base OFFSET_SURF constructions and their saved surface carriers. Close finite branch/range selection for terminal or parameter-lane-free procedural intersections. |
