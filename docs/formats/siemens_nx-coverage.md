...
The full validation profile passes cumulatively through L3. Profile version 11
records saved-body re-derivation as separate L6 evidence, marks external-only
