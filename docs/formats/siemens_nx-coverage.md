...
| L2 | Incomplete | Extend graph-only NURBS-base OFFSET_SURF saved-carrier identity beyond certified affine-support fits. Close finite branch/range selection for terminal or parameter-lane-free procedural intersections. |
