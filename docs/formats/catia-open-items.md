...
- The field semantics of the class-`0x18` analytic-circle descriptor and the operands and individual eight-scalar lanes in its class-`0x23` edge definition are unresolved. The corresponding roles in standalone class-`0x24` records and the field grammar and geometric role of class-`0x25` remain unresolved.
