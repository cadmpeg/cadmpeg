...
- The semantic roles and namespace of the five allocation values following the fixed tagged-one prefix in each `5e 1a` edge-stride record remain unresolved.
