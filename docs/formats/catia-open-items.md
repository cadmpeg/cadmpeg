...
- The parameter equation for noncircular `b5 03 1a` conics and the native station-to-chart branch equation of class-`1d` sphere great circles are unresolved.
...
- The payload grammar and operation semantics of `b5 03 3b` surface records are unresolved.
