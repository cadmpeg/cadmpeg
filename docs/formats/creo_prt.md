...
The positional generated-arc scalar lane maps `cc`, `d0`, `d2`, `d5`, `de`,
and `df` to IEEE prefixes `bf f9`, `bf fe`, `c0 00`, `c0 03`, `c0 10`, and
`c0 11`, respectively. Outside that positional arc lane, saved-entity `d5`
is the negative subunit form `[bf, tail6, 00]`.
