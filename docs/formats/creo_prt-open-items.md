...
- The equations relating `MdlRefInfo` conic types other than the defined
  ...
  including parabola and hyperbola carrier parameters. The compact `0x11`
  `t1` form is also unspecified.
...
- Section-to-datum joins, relation equations other than signed type-zero linear
  ...
  relation direction selectors, `skamp_ptr` incidence types 10 through 13, 15,
  and 35, and the `ed ba 10 0c 8d ee 90 b4 0c` solver sentinel are unspecified.
