...
- Section-to-datum joins, relation equations other than signed type-zero linear dimensions and type-14 radii, `skamp_ptr` incidence types 6, 10 through 13, and 15 or later, and the `ed ba 10 0c 8d ee 90 b4 0c` solver sentinel are unspecified.
