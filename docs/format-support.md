...
- **Topology: Partial.** Native half-edges and closed loops decode. Components with uniquely solved plane/plane/plane, plane/plane/cylinder, plane/plane/cone, plane/plane/sphere, plane/sphere/sphere, plane/coaxial-cone/tangent-sphere, plane/equal-radius-coaxial-cylinder/sphere, plane/axis-centered-tangent-sphere/torus, plane/tangent-coaxial-tori, plane/plane/tangent-torus, or plane/tangent-cylinder-pair vertex coordinates transfer as connected body, region, shell, face, loop, coedge, edge, and vertex graphs. Planar multi-loop faces require one strict containment outer boundary; non-planar faces transfer only with one loop until their byte-backed outer/inner discriminator is decoded. Multiple analytic intersection roots remain unresolved, and unsolved carriers stay linked opaque geometry rather than being guessed.
- **Tessellation: None.**
