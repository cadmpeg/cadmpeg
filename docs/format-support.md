...
- **Tessellation: Partial.** Embedded JT 9 shape-LOD segments decode lossless and uniformly quantized coordinates, reconstruct topological dual-mesh connectivity, resolve logical shape-node to late-loaded payload ownership, and transfer nonnegative-group triangles in document units. Body association, normals, texture coordinates, colors, and transformed scene instances remain unresolved.
