...
| ------------------------------------------ | -------------- | ----------------------------------------------------------------------------------------------------- |
| FreeCAD `.FCStd` (schema 4, file 1)        | **L5 tested**  | product, drawing, application retention, and exact byte accounting                                    |
...
**Ladder: L5 tested.** The generated public-corpus profile currently passes the cumulative
container, persistence, geometry, connected-model, design-record, and appearance gates. Complete
sketch-constraint and core Part/PartDesign operation-family evidence is the next failed gate;
higher capabilities remain extras until every intervening gate passes. Schema versions 2 and 3
...
- **FreeCAD `.FCStd` schema 4/file 1 (L5 tested):** text and binary exact geometry, connected
  topology, design records, appearance, and exact byte accounting, with higher document domains
  available as unscored extras. Read only.
