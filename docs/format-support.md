...
- **Presentation and metadata: Inspect.** Length-bounded Parasolid attribute-class declarations retain stream-local identity, exact printable class name, and inflated-stream offset. Attribute instances, ownership bindings, colors, materials, and other presentation values remain unresolved.
