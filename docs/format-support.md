...
- **Geometry: Partial.** ActDatums and VisibGeom plane carriers transfer in model space. Topology-bound cylinders transfer when cap records establish their complete placement. Plane/plane intersections transfer as lines; unique plane/cylinder intersections transfer as circles, ellipses, or tangent lines. Parallel secant planes remain unresolved because they define two distinct lines. Other analytic and spline families remain incomplete.
