...
- **Container and versions: Partial.** The codec decodes `V5_CFV2` containers, reads the saved-by CATIA version/release/service-pack/hot-fix tuple, and distinguishes standard-nested, FBB-only, zero-entity, float-packed, E5, and inner-without-directory layouts.
