...
| Rhino `.3dm` (archive 50/60/70/80)         | **L6 tested**  | complete built-in shapes, native constructions, history values, evaluated dimensions                  |
...
- **Rhino `.3dm` (L6 tested for archive 50/60/70/80):** complete archive-bearing built-in shape carriers, connected topology, native constructions, dimensions, and ordered history semantics. V3/V4 score L1; V1/V2 and archive 5 score L0. Read only.
...
**Ladder: L6 tested for archive 50/60/70/80; L1 tested for V3/V4; L0 tested for V1/V2 and archive 5.**
